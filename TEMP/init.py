...
class Atom():
    ...
    def update_forces(self):
        if len(self.position) > 1:
            ...
            self.CCSD_forces.append(-(self.CCSD_energies[-1] - self.CCSD_energies[-2])/distance_delta)
    ...
    def write_n_plot(self):
        if self.condition:
            ...
            f.write("CCSD Energy: \n{}, #{} \n \n".format(self.CCSD_energies, len(self.CCSD_energies)))
            f.write("CCSD Forces: \n{}, #{} \n \n".format(self.CCSD_forces, len(self.CCSD_forces)))
...
class System():
    ...
    def initalize_energy(self):
        ...
        for atom in self.atoms:
            ...
            atom.CCSD_energies.append(results["CCSD Energy"])
        ...
        print("""Energy for system {} initialized at: \n FCI: {} \n VQE: {} \n CCSD: {}""".format(self.name, results["FCI Energy"], results["VQE Energy"], results["CCSD Energy"]))
    ...
    def write_n_plot(self):
        ...
        if len(self.fci_energies) > 2:
            ...
            print("FCI Energy: {}, #{}".format(self.fci_energies, len(self.fci_energies)))
            print("VQE Energy: {}, #{}".format(self.VQE_energies, len(self.VQE_energies)))
            print("CCSD Energy: {}, #{}".format(self.CCSD_energies, len(self.CCSD_energies)))
