...
plt.savefig("FP-01-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-01-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-01-distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-01-Velocity", dpi=400, orientation='portrait')
