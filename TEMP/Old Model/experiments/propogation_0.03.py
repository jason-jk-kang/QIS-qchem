...
plt.savefig("FP-03-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-03-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-03-distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-03-Velocity", dpi=400, orientation='portrait')
