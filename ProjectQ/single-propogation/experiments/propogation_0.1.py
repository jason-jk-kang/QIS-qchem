...
plt.savefig("FP-1-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-1-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-1-distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-1-Velocity", dpi=400, orientation='portrait')
