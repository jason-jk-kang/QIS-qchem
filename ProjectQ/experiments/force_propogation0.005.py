...
plt.savefig("FP-005-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-005-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-005-Distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-005-Velocity", dpi=400, orientation='portrait')
