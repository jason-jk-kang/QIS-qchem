...
plt.savefig("FP-010-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-010-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-010-Distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-010-Velocity", dpi=400, orientation='portrait')
