...
plt.savefig("FP-0.015-Force", dpi=400, orientation='portrait')
...
plt.savefig("FP-0.015-Energy", dpi=400, orientation='portrait')
...
plt.savefig("FP-0.015-Distance", dpi=400, orientation='portrait')
...
plt.savefig("FP-0.015-Velocity", dpi=400, orientation='portrait')
